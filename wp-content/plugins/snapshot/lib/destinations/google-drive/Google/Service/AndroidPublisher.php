 ...
 *  </code>
 */
if (!class_exists('Google_Service_AndroidPublisher_Inapppurchases_Resource')) {
 ...
 *  </code>
 */
if (!class_exists('Google_Service_AndroidPublisher_Purchases_Resource')) {
...
if (!class_exists('Google_Service_AndroidPublisher_InappPurchase')) {
...
if (!class_exists('Google_Service_AndroidPublisher_SubscriptionPurchase')) {
